...
# Video Capture 
capture = cv2.VideoCapture('Video_001.mp4') # Webcam
#capture = cv2.VideoCapture('Video_001.avi') # Video file location
 
fgbg = cv2.createBackgroundSubtractorMOG2() # History, Threshold, DetectShadows
...
while True:
	...
	if (FrameCount > 1 and count > 500): # Number of pixels to be considered as movement
		print('Motion detected!')
		cv2.putText(ResizedFrame, 'Motion detected!', (10, 50), 
